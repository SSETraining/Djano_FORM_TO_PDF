...
def index(request):
    ...
    data={"Question":Question.objects.all(),"Modern_Home":Modern_Home.objects.all(),"Sales_team":Sales_team.objects.all(),"Finished_Inventory":Finished_Inventory.objects.all()}
    print("Data loded",data)
